...
const Rewards = () => {
  ...
  const data = [
    {
      ...
      details: ["Click to refer a loan"],
      subCategories: [
        { key: "1-1", title: "Business Loan", rewards: 0.005 },
        { key: "1-2", title: "Vehicle Loan", rewards: 0.01 },
        { key: "1-3", title: "Home Loan", rewards: 0.015 },
      ],
    },
    {
      key: "2",
      ...
      details: ["Click to refer insurance"],
      subCategories: [
        { key: "2-1", title: "Life Insurance", rewards: 0.02 },
        { key: "2-2", title: "Health Insurance", rewards: 0.15 },
        { key: "2-3", title: "Vehicle Insurance", rewards: 0.1 },
      ],
    },
    {
      key: "3",
  ...
  const handleReferralClick = async (subCategory) => {
    const userId = localStorage.getItem("id");
    try {
    ...
    <div className="rewards-container">
      <div className="dashboard-header">
        ...
        <div className="summary-cards">
          ...
          <Card className="summary-card">
            <Title level={5}>Total Income: ₹{totalIncome.toFixed(2)}</Title>
          </Card>
        </div>
      </div>
                    ...
                    >
                      <Card className="sub-card-full">
                        ...
                        <Button
                          ...
                          size="small"
                          className="add-referral-button"
                          onClick={() => handleReferralClick(subItem)}
                        >
                          Add Referral
                        </Button>
                      </Card>
