...
//   console.log("userNotificationId", userNotificationId);
//   useEffect(() => {
//     if (email) {
//       getNotification();
//     }
...
//       setNotification(response.data.data.addremarks);
...
//     await Api.delete(`/lead/delete/${userNotificationId}/remark/${id}`).then(
//       (res) => {
//         setDelete(res);
//       }
//     );
...
//               </p>
//               <p>
//                 <strong className="notification-heading">Remarks:</strong>{" "}
