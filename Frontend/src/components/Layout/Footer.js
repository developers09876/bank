        ...
        <div className="max-w-screen-xl p-6 py-8 mx-auto lg:py-12 md:px-6 lg:px-8">
          ...
          <div>
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                <strong>Address:</strong>Registered address of Vilu Genius is 26832/20/3A, <br/> Someshwara Extension,<br/>  1st Main, Doddaballapur,<br/>  Karnataka, India-561203.
              </p>
            </div>
          ...
          <div className="text-center mt-6">
            <span className="text-sm text-gray-500">
              © 2022-2023 VILU GENIUS™. All Rights Reserved.
            </span>
          </div>
        </div>
      </footer>
